            ...
            <div>
                <Navbar color="faded" light style={{ backgroundColor: 'white', zIndex: '5', padding: '1rem 1rem' }}>
                    ...
                    <Collapse isOpen={this.state.isOpen} navbar>
                        <Nav navbar>
                            <Link style={navItem} className="nav-item" to="" >
                                Home
                            </Link>
                            <Link style={navItem} className="nav-item" to="about" >
                                About
                            </Link>
                            <Link style={navItem} className="nav-item" to="works" >
                                Works
                            </Link>
                            <Link style={navItem} className="nav-item" to="blog" >
                                Tutorials
                            </Link>
                            <Link style={navItem} className="nav-item" to="contact" >
                                Contact
                            </Link>
                        </Nav>
                    </Collapse>
